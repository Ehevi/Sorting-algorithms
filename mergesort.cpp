...
void merge(int t[], int left, int middle, int right) //fcja scalajaca//
{
...
void mergeSort(int t[], int left, int right) //glowna fcja sortujaca//
{
...
// Wypelniam tablice d[] liczbami pseudolosowymi i wyswietlam jej zawartosc
